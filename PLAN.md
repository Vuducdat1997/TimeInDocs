...
| --- | --- | --- |
| 2026-09-17 | Base giao diện dùng chung: `TimeInAppBar` thay mọi `AppBar` tự dựng, thêm `docs/UI-BASE.md` làm file base cho agent. Thêm ô “Ghi nhớ đăng nhập” | `flutter analyze` sạch, 24 test đạt. Thanh điều hướng đúng thiết kế trên máy ảo. Test cũ dùng tooltip nay chuyển sang menu tài khoản |
